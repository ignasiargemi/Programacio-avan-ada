...
public class execucio {
	public static void main(String args[]) throws Exception{
		...
		funcio seleccio: volem optimitzar el viatge, per tant la nostre funcio consultara els km k pot recorre amb el diposit ple i escollira la gasolinera que s'apropi mï¿½s als km k pot recorre(mes petit o igual)
