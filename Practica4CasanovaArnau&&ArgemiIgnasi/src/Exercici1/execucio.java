	...
	public static void main(String args[]) throws Exception{
		...
		if (resposta.equalsIgnoreCase("SI")) {
			...
			while (gasolineres[nombreGasolineres] < 1 || gasolineres[nombreGasolineres] > kmCotxeDipositPle) {
				msgLN("Les distancies que has introduit no sÃ³n correctes.");
		...
		La nostre solució sempre trobarà la millor solució perquè segeuix el procediment explicat abans.
		*/
	}
